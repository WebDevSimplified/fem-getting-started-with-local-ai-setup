...
A **general-purpose instruct model** is a good default for conversation, rewriting, summarizing, extracting information, and answering general questions. These models are flexible, but they are not always the strongest option for specialized work.
